  ...
  <div class="mapType">
    ...
    <a-row type="flex" justify="space-between" class="ssa-header">
      ...
      <a-col :span="12" style="text-align: right">
        ...
        <a-button type="success" icon="plus" size="small" @click="onOpenModal">
          Add Defect Code
        </a-button>
          <a-input size="small" placeholder="Please input keyword" v-model="keyWord" />
    ...
    />
    <add-defect-code ref="addDefectCodeRef"></add-defect-code>
  </div>
</template>

<script>
import { COLUMNS } from "./constant";
import { fetchMapTypes, deleteMapType,updateMapTypeStatus } from "./service";
import AddDefectCode from './components/addDefectCode.vue'
export default {
  name: "mapType",
  components: {
    AddDefectCode
  ...
  methods: {
    ...
    onOpenModal(){
      this.$refs.addDefectCodeRef.initModal()
    }
  },
};
</script>
